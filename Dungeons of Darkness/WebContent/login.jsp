...
<html>
	<head>
		<title>Login - Dungeons of Darkness</title>
		<meta charset="UTF-8">
		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
				<form class="login100-form validate-form" action="LoginServlet" method="post">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Senha é requerida">
					...
					<div class="text-center w-full p-t-115">
						<span class="txt1">
							...
							<a class="txt1 bo1 hov1" href="cadastro.jsp">
							Criar conta
							</a>
						</div>
					</form>
